...
class Policy(nn.Module):
    ...
    def make_all_embedding(self, eg: EGraph.EGraph) -> tuple[list[EGraph.ENode], list[torch.Tensor], list[torch.Tensor]]:
        visited_nodes: dict[EGraph.ENode, torch.Tensor] = {}
    ...
    def forward(self, eg: EGraph.EGraph):
        nodes, nodes_embeddings, class_embeddings = self.make_all_embedding(eg)
